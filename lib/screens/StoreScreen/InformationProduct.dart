...
class InformationProduct extends StatefulWidget {
  @override
  _InformationProductState createState() => _InformationProductState();
}

class _InformationProductState extends State<InformationProduct> {
  List<Map<String, String>> _filteredProductList = getAllProducts();
  final TextEditingController _searchController = TextEditingController();

  @override
  Widget build(BuildContext context) {
    final bestSellingProducts = getBestSellingProducts();
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
            ...
            child: Container(
              ...
              child: TextField(
                ...
                onChanged: (query) => setState(() {
                  _filteredProductList = getAllProducts().where((product) {
          ...
          Expanded(
            child: BestSellingProductsView(products: bestSellingProducts),
          ),
        ],
      ),
    );
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return ZoomableProductCard(
          ...
          showRatingType: 'store', // Show store rating for all products
        );
      },
    );
  }
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return ZoomableProductCard(
          ...
          showRatingType:
              'product', // Show product rating for best-selling products
        );
      },
    );
  }
            ...
            trailing: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    SizedBox(width: 4),
                    widget.showRatingType == 'store'
                        ? Text(
                            'Rating Store : ${widget.product['storeRating']}')
